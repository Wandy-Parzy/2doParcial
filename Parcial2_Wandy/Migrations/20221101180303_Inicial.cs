        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VerdurasDetalles_Verduras_VitaminaId",
                        column: x => x.VitaminaId,
            ...
            migrationBuilder.InsertData(
                table: "Vitaminas",
                columns: new[] { "VitaminaId", "Nombre" },
                values: new object[] { 3, "Vitamina B " });

            migrationBuilder.InsertData(
                table: "Vitaminas",
                columns: new[] { "VitaminaId", "Nombre" },
                values: new object[] { 4, "Vitamina C " });

            migrationBuilder.InsertData(
                table: "Vitaminas",
                columns: new[] { "VitaminaId", "Nombre" },
                values: new object[] { 5, "Vitamina D " });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VerdurasDetalles_VitaminaId",
